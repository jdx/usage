...
export function socialCard(title) {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1200" height="630" viewBox="0 0 1200 630">
    <rect width="1200" height="630" fill="#170f22"/>
    <rect width="1200" height="8" fill="#ff2d95"/>
    <g font-family="Space Grotesk">
      <text x="64" y="85" font-size="30" fill="#ff2d95">usage / docs</text>
      ${heading}
      <path d="M64 508 H1136" stroke="#3d3540"/>
      <text x="64" y="564" font-size="26" fill="#c2b6a4">usage.jdx.dev</text>
      <text x="1136" y="564" text-anchor="end" font-size="26" fill="#ff2d95">usage</text>
    </g>
