...
pub struct Cli {
    ...
    #[usage(long = "streaming", choices("simple", "json"))]
    pub streaming: ::std::option::Option<::std::string::String>,
    /// Sort languages based on column
    #[usage(
        long = "sort",
        short = 's',
        conflicts = "--rsort",
        choices("files", "lines", "blanks", "code", "comments")
    )]
    ...
    pub rsort: ::std::option::Option<::std::string::String>,
