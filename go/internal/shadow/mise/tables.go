...
var Meta = argv.Metadata{
	...
	{Key: FlagQuiet, Name: "quiet", Flag: true, Spelling: "--quiet", Overrides: []uint64{FlagSilent, FlagTrace, FlagVerbose, FlagDebug, FlagLogLevel}},
	...
	{Key: FlagVerbose, Name: "verbose", Flag: true, Spelling: "--verbose", Overrides: []uint64{FlagQuiet, FlagSilent, FlagTrace, FlagDebug}},
	{Key: FlagVersion, Name: "version", Flag: true, Spelling: "--version"},
	{Key: FlagYes, Name: "yes", Flag: true, Spelling: "--yes"},
	{Key: FlagDebug, Name: "debug", Flag: true, Spelling: "--debug", Overrides: []uint64{FlagQuiet, FlagTrace, FlagVerbose, FlagSilent, FlagLogLevel}},
	...
	{Key: FlagSilent, Name: "silent", Flag: true, Spelling: "--silent", Overrides: []uint64{FlagQuiet, FlagTrace, FlagVerbose, FlagDebug, FlagLogLevel}},
	{Key: FlagTimings, Name: "timings", Flag: true, Spelling: "--timings"},
	{Key: FlagTrace, Name: "trace", Flag: true, Spelling: "--trace", Overrides: []uint64{FlagQuiet, FlagSilent, FlagVerbose, FlagDebug, FlagLogLevel}},
	...
	{},
	{},
	{Key: FlagBinPathsBinNames, Name: "bin-names", Flag: true, Spelling: "--bin-names", DefaultIf: []argv.DefaultIf{{Key: FlagBinPathsJson, Value: "true"}}},
	...
	{Key: FlagBootstrapDotfilesAddGlobal, Name: "global", Flag: true, Spelling: "--global", Conflicts: []uint64{FlagBootstrapDotfilesAddLocal, FlagBootstrapDotfilesAddPath}},
	{Key: FlagBootstrapDotfilesAddLocal, Name: "local", Flag: true, Spelling: "--local", Conflicts: []uint64{FlagBootstrapDotfilesAddGlobal, FlagBootstrapDotfilesAddPath}},
	...
	{Key: FlagBootstrapPackagesImportGlobal, Name: "global", Flag: true, Spelling: "--global", Conflicts: []uint64{FlagBootstrapPackagesImportEnv, FlagBootstrapPackagesImportPath}},
	...
	{Key: FlagBootstrapRemoteCopyLinks, Name: "copy-links", Flag: true, Spelling: "--copy-links"},
	...
	{Key: FlagDotfilesAddGlobal, Name: "global", Flag: true, Spelling: "--global", Conflicts: []uint64{FlagDotfilesAddLocal, FlagDotfilesAddPath}},
	{Key: FlagDotfilesAddLocal, Name: "local", Flag: true, Spelling: "--local", Conflicts: []uint64{FlagDotfilesAddGlobal, FlagDotfilesAddPath}},
	...
	{},
	{Key: FlagEnvDotenv, Name: "dotenv", Flag: true, Spelling: "--dotenv", Overrides: []uint64{FlagEnvShell}},
	{Key: FlagEnvJson, Name: "json", Flag: true, Spelling: "--json", Overrides: []uint64{FlagEnvShell}},
	{Key: FlagEnvShell, Name: "shell", Flag: true, Spelling: "--shell", ValueName: "SHELL", Overrides: []uint64{FlagEnvJson}},
	{Key: FlagEnvJsonExtended, Name: "json-extended", Flag: true, Spelling: "--json-extended", Overrides: []uint64{FlagEnvShell}},
	...
	{Key: FlagExecRaw, Name: "raw", Flag: true, Spelling: "--raw", Overrides: []uint64{FlagExecJobs}},
	...
	{Key: FlagGenerateBootstrapWindows, Name: "windows", Flag: true, Spelling: "--windows", Requires: []uint64{FlagGenerateBootstrapWrite}},
	{},
	{Key: FlagGenerateConfigGlobal, Name: "global", Flag: true, Spelling: "--global", Conflicts: []uint64{ArgGenerateConfigPath}},
	...
	{Key: FlagGenerateToolStubFetch, Name: "fetch", Flag: true, Spelling: "--fetch", Conflicts: []uint64{FlagGenerateToolStubUrl, FlagGenerateToolStubPlatformUrl, FlagGenerateToolStubVersion, FlagGenerateToolStubBin, FlagGenerateToolStubPlatformBin, FlagGenerateToolStubSkipDownload, FlagGenerateToolStubLock}},
	{Key: FlagGenerateToolStubHttp, Name: "http", Flag: true, Spelling: "--http", ValueName: "HTTP", Default: []string{"http"}},
	{Key: FlagGenerateToolStubLock, Name: "lock", Flag: true, Spelling: "--lock", Conflicts: []uint64{FlagGenerateToolStubUrl, FlagGenerateToolStubPlatformUrl, FlagGenerateToolStubBin, FlagGenerateToolStubPlatformBin, FlagGenerateToolStubFetch, FlagGenerateToolStubSkipDownload}},
	...
	{Key: FlagGithubTokenRefresh, Name: "refresh", Flag: true, Spelling: "--refresh", Requires: []uint64{FlagGithubTokenOauth}},
	...
	{},
	{Key: FlagGlobalFuzzy, Name: "fuzzy", Flag: true, Spelling: "--fuzzy", Overrides: []uint64{FlagGlobalPin}},
	{Key: FlagGlobalPath, Name: "path", Flag: true, Spelling: "--path"},
	{Key: FlagGlobalPin, Name: "pin", Flag: true, Spelling: "--pin", Overrides: []uint64{FlagGlobalFuzzy}},
	...
	{},
	{Key: FlagEditGlobal, Name: "global", Flag: true, Spelling: "--global", Conflicts: []uint64{ArgEditPath}},
	...
	{Key: FlagInstallIncludeTaskTools, Name: "include-task-tools", Flag: true, Spelling: "--include-task-tools"},
	...
	{Key: FlagInstallMonorepo, Name: "monorepo", Flag: true, Spelling: "--monorepo", Env: "MISE_MONOREPO"},
	{Key: FlagInstallRaw, Name: "raw", Flag: true, Spelling: "--raw", Overrides: []uint64{FlagInstallJobs}},
	{Key: FlagInstallShared, Name: "shared", Flag: true, Spelling: "--shared", ValueName: "SHARED", Conflicts: []uint64{FlagInstallSystem}},
	{Key: FlagInstallSystem, Name: "system", Flag: true, Spelling: "--system", Conflicts: []uint64{FlagInstallShared}},
	...
	{Key: FlagLocalFuzzy, Name: "fuzzy", Flag: true, Spelling: "--fuzzy", Overrides: []uint64{FlagLocalPin}},
	{Key: FlagLocalPath, Name: "path", Flag: true, Spelling: "--path"},
	{Key: FlagLocalPin, Name: "pin", Flag: true, Spelling: "--pin", Overrides: []uint64{FlagLocalFuzzy}},
	...
	{Key: FlagLsGlobal, Name: "global", Flag: true, Spelling: "--global", Conflicts: []uint64{FlagLsLocal}},
	{Key: FlagLsInstalled, Name: "installed", Flag: true, Spelling: "--installed"},
	{Key: FlagLsJson, Name: "json", Flag: true, Spelling: "--json"},
	{Key: FlagLsLocal, Name: "local", Flag: true, Spelling: "--local", Conflicts: []uint64{FlagLsGlobal}},
	{Key: FlagLsMissing, Name: "missing", Flag: true, Spelling: "--missing", Conflicts: []uint64{FlagLsInstalled}},
	...
	{Key: FlagLsAllSources, Name: "all-sources", Flag: true, Spelling: "--all-sources", Conflicts: []uint64{FlagLsCurrent, FlagLsGlobal, FlagLsLocal, FlagLsPrunable}},
	{Key: FlagLsMonorepo, Name: "monorepo", Flag: true, Spelling: "--monorepo", Env: "MISE_MONOREPO", Conflicts: []uint64{FlagLsAllSources, FlagLsPrunable}},
	{Key: FlagLsNoHeader, Name: "no-header", Flag: true, Spelling: "--no-header", Conflicts: []uint64{FlagLsJson}},
	...
	{},
	{Key: FlagLsRemoteAll, Name: "all", Flag: true, Spelling: "--all", Conflicts: []uint64{ArgLsRemoteToolVersion, ArgLsRemotePrefix}},
	...
	{Key: FlagLsRemoteStrictMetadata, Name: "strict-metadata", Flag: true, Spelling: "--strict-metadata", Requires: []uint64{FlagLsRemoteJson, FlagLsRemoteNoVersionsHost}},
	...
	{Key: FlagOutdatedL, Name: "l", Flag: true, Spelling: "-l"},
	{Key: FlagOutdatedInactive, Name: "inactive", Flag: true, Spelling: "--inactive", Conflicts: []uint64{FlagOutdatedLocal}},
	...
	{Key: FlagPluginsCore, Name: "core", Flag: true, Spelling: "--core", Conflicts: []uint64{FlagPluginsAll}},
	{Key: FlagPluginsUrls, Name: "urls", Flag: true, Spelling: "--urls"},
	{Key: FlagPluginsRefs, Name: "refs", Flag: true, Spelling: "--refs"},
	{Key: FlagPluginsUser, Name: "user", Flag: true, Spelling: "--user", Conflicts: []uint64{FlagPluginsAll}},
	{},
	{Key: FlagPluginsInstallAll, Name: "all", Flag: true, Spelling: "--all", Conflicts: []uint64{ArgPluginsInstallNewPlugin, FlagPluginsInstallForce}},
	...
	{Key: FlagPluginsLsCore, Name: "core", Flag: true, Spelling: "--core", Conflicts: []uint64{FlagPluginsLsAll}},
	...
	{Key: FlagPluginsLsUser, Name: "user", Flag: true, Spelling: "--user", Conflicts: []uint64{FlagPluginsLsAll}},
	{},
	...
	{},
	{Key: FlagPluginsUninstallAll, Name: "all", Flag: true, Spelling: "--all", Conflicts: []uint64{ArgPluginsUninstallPlugin}},
	...
	{Key: FlagDepsMonorepo, Name: "monorepo", Flag: true, Spelling: "--monorepo", Env: "MISE_MONOREPO"},
	...
	{Key: FlagDepsInstallMonorepo, Name: "monorepo", Flag: true, Spelling: "--monorepo", Env: "MISE_MONOREPO"},
	...
	{Key: FlagRegistrySecurity, Name: "security", Flag: true, Spelling: "--security", Requires: []uint64{FlagRegistryJson}},
	{Key: ArgRegistryName, Name: "NAME"},
	{},
	{},
	...
	{Key: FlagRunAffectedExplain, Name: "affected-explain", Flag: true, Spelling: "--affected-explain", Conflicts: []uint64{FlagRunAffectedJson}, Requires: []uint64{FlagRunAffected}},
	...
	{Key: FlagRunAffectedJson, Name: "affected-json", Flag: true, Spelling: "--affected-json", Conflicts: []uint64{FlagRunAffectedExplain}, Requires: []uint64{FlagRunAffected}},
	{Key: FlagRunAll, Name: "all", Flag: true, Spelling: "--all", Conflicts: []uint64{FlagRunAffected}},
	...
	{Key: FlagRunQuiet, Name: "quiet", Flag: true, Spelling: "--quiet", Env: "MISE_QUIET"},
	{Key: FlagRunRaw, Name: "raw", Flag: true, Spelling: "--raw"},
	{Key: FlagRunShell, Name: "shell", Flag: true, Spelling: "--shell", ValueName: "SHELL"},
	{Key: FlagRunSilent, Name: "silent", Flag: true, Spelling: "--silent", Env: "MISE_SILENT"},
	...
	{Key: FlagRunNoCache, Name: "no-cache", Flag: true, Spelling: "--no-cache", Env: "MISE_TASK_REMOTE_NO_CACHE"},
	...
	{Key: FlagRunSkipDeps, Name: "skip-deps", Flag: true, Spelling: "--skip-deps", Env: "MISE_TASK_SKIP_DEPENDS"},
	...
	{Key: FlagRunTaskCacheExplainJson, Name: "task-cache-explain-json", Flag: true, Spelling: "--task-cache-explain-json", Conflicts: []uint64{FlagRunTaskCacheExplain}, Requires: []uint64{FlagRunDryRun}},
	{Key: FlagRunTaskCacheStats, Name: "task-cache-stats", Flag: true, Spelling: "--task-cache-stats", Conflicts: []uint64{FlagRunDryRun}},
	...
	{},
	{Key: FlagSearchInteractive, Name: "interactive", Flag: true, Spelling: "--interactive", Conflicts: []uint64{FlagSearchMatchType, FlagSearchNoHeader}},
	...
	{Key: FlagSetGlobal, Name: "global", Flag: true, Spelling: "--global", Overrides: []uint64{FlagSetFile, FlagSetEnv}},
	{Key: FlagSetAgeEncrypt, Name: "age-encrypt", Flag: true, Spelling: "--age-encrypt", Requires: []uint64{ArgSetEnvVar}},
	...
	{Key: FlagSetStdin, Name: "stdin", Flag: true, Spelling: "--stdin", Conflicts: []uint64{FlagSetPrompt}, Requires: []uint64{ArgSetEnvVar}},
	...
	{Key: FlagShellRaw, Name: "raw", Flag: true, Spelling: "--raw", Overrides: []uint64{FlagShellJobs}},
	...
	{},
	{Key: FlagSyncRubyBrew, Name: "brew", Flag: true, Required: true, Spelling: "--brew"},
	{},
	{Key: FlagTasksGlobal, Name: "global", Flag: true, Spelling: "--global", Overrides: []uint64{FlagTasksLocal}},
	{Key: FlagTasksJson, Name: "json", Flag: true, Spelling: "--json"},
	{Key: FlagTasksLocal, Name: "local", Flag: true, Spelling: "--local", Overrides: []uint64{FlagTasksGlobal}},
	...
	{Key: FlagTasksNameOnly, Name: "name-only", Flag: true, Spelling: "--name-only", Conflicts: []uint64{FlagTasksJson, FlagTasksExtended, FlagTasksUsage}},
	...
	{},
	{Key: FlagTasksDepsCompact, Name: "compact", Flag: true, Spelling: "--compact", Conflicts: []uint64{FlagTasksDepsDot}},
	...
	{Key: FlagTasksGraphExplain, Name: "explain", Flag: true, Spelling: "--explain", Conflicts: []uint64{FlagTasksGraphJson}},
	...
	{Key: ArgTasksInfoTask, Name: "TASK", Required: true},
	{},
	{Key: FlagTasksLsGlobal, Name: "global", Flag: true, Spelling: "--global", Overrides: []uint64{FlagTasksLsLocal}},
	{Key: FlagTasksLsJson, Name: "json", Flag: true, Spelling: "--json"},
	{Key: FlagTasksLsLocal, Name: "local", Flag: true, Spelling: "--local", Overrides: []uint64{FlagTasksLsGlobal}},
	...
	{Key: FlagTasksLsNameOnly, Name: "name-only", Flag: true, Spelling: "--name-only", Conflicts: []uint64{FlagTasksLsJson, FlagTasksLsExtended, FlagTasksLsUsage}},
	...
	{Key: FlagTasksRunAffectedExplain, Name: "affected-explain", Flag: true, Spelling: "--affected-explain", Conflicts: []uint64{FlagTasksRunAffectedJson}, Requires: []uint64{FlagTasksRunAffected}},
	...
	{Key: FlagTasksRunAffectedJson, Name: "affected-json", Flag: true, Spelling: "--affected-json", Conflicts: []uint64{FlagTasksRunAffectedExplain}, Requires: []uint64{FlagTasksRunAffected}},
	{Key: FlagTasksRunAll, Name: "all", Flag: true, Spelling: "--all", Conflicts: []uint64{ArgTasksRunTask, FlagTasksRunAffected}},
	...
	{Key: FlagTasksRunQuiet, Name: "quiet", Flag: true, Spelling: "--quiet", Env: "MISE_QUIET"},
	...
	{Key: FlagTasksRunSilent, Name: "silent", Flag: true, Spelling: "--silent", Env: "MISE_SILENT"},
	...
	{Key: FlagTasksRunNoCache, Name: "no-cache", Flag: true, Spelling: "--no-cache", Env: "MISE_TASK_REMOTE_NO_CACHE"},
	...
	{Key: FlagTasksRunSkipDeps, Name: "skip-deps", Flag: true, Spelling: "--skip-deps", Env: "MISE_TASK_SKIP_DEPENDS"},
	...
	{Key: FlagTasksRunTaskCacheExplainJson, Name: "task-cache-explain-json", Flag: true, Spelling: "--task-cache-explain-json", Conflicts: []uint64{FlagTasksRunTaskCacheExplain}, Requires: []uint64{FlagTasksRunDryRun}},
	{Key: FlagTasksRunTaskCacheStats, Name: "task-cache-stats", Flag: true, Spelling: "--task-cache-stats", Conflicts: []uint64{FlagTasksRunDryRun}},
	...
	{},
	{Key: FlagTestToolAll, Name: "all", Flag: true, Spelling: "--all", Conflicts: []uint64{ArgTestToolTools, FlagTestToolAllConfig}},
	{Key: FlagTestToolJobs, Name: "jobs", Flag: true, Spelling: "--jobs", ValueName: "JOBS", Env: "MISE_TEST_TOOL_JOBS"},
	{Key: FlagTestToolAllConfig, Name: "all-config", Flag: true, Spelling: "--all-config", Conflicts: []uint64{ArgTestToolTools, FlagTestToolAll}},
	{Key: FlagTestToolIncludeNonDefined, Name: "include-non-defined", Flag: true, Spelling: "--include-non-defined"},
	{Key: FlagTestToolRaw, Name: "raw", Flag: true, Spelling: "--raw", Overrides: []uint64{FlagTestToolJobs}},
	...
	{Key: FlagTokenGithubRefresh, Name: "refresh", Flag: true, Spelling: "--refresh", Requires: []uint64{FlagTokenGithubOauth}},
	...
	{},
	{Key: FlagTrustAll, Name: "all", Flag: true, Spelling: "--all", Conflicts: []uint64{FlagTrustIgnore, FlagTrustUntrust}},
	{Key: FlagTrustIgnore, Name: "ignore", Flag: true, Spelling: "--ignore", Conflicts: []uint64{FlagTrustUntrust}},
	...
	{Key: FlagUnsetGlobal, Name: "global", Flag: true, Spelling: "--global", Overrides: []uint64{FlagUnsetFile}},
	...
	{Key: FlagUnuseGlobal, Name: "global", Flag: true, Spelling: "--global", Overrides: []uint64{FlagUnusePath, FlagUnuseEnv}},
	...
	{Key: FlagUpgradeInteractive, Name: "interactive", Flag: true, Spelling: "--interactive", Conflicts: []uint64{ArgUpgradeInstalledToolVersion}},
	{Key: FlagUpgradeJobs, Name: "jobs", Flag: true, Spelling: "--jobs", ValueName: "JOBS", Env: "MISE_JOBS"},
	{Key: FlagUpgradeL, Name: "l", Flag: true, Spelling: "-l"},
	...
	{Key: FlagUpgradeInactive, Name: "inactive", Flag: true, Spelling: "--inactive", Conflicts: []uint64{FlagUpgradeLocal}},
	...
	{Key: FlagUpgradeNoPrune, Name: "no-prune", Flag: true, Spelling: "--no-prune", Overrides: []uint64{FlagUpgradePrune}},
	{Key: FlagUpgradePrune, Name: "prune", Flag: true, Spelling: "--prune", Overrides: []uint64{FlagUpgradeNoPrune}},
	{Key: FlagUpgradeRaw, Name: "raw", Flag: true, Spelling: "--raw", Overrides: []uint64{FlagUpgradeJobs}},
	...
	{Key: FlagUseForce, Name: "force", Flag: true, Spelling: "--force", Requires: []uint64{ArgUseToolVersion}},
	{Key: FlagUseGlobal, Name: "global", Flag: true, Spelling: "--global", Overrides: []uint64{FlagUsePath, FlagUseEnv}},
	...
	{Key: FlagUseFuzzy, Name: "fuzzy", Flag: true, Spelling: "--fuzzy", Overrides: []uint64{FlagUsePin}},
	...
	{Key: FlagUsePin, Name: "pin", Flag: true, Spelling: "--pin", Overrides: []uint64{FlagUseFuzzy}},
	{Key: FlagUseRaw, Name: "raw", Flag: true, Spelling: "--raw", Overrides: []uint64{FlagUseJobs}},
	...
	{Key: FlagWatchRestart, Name: "restart", Flag: true, Spelling: "--restart", Conflicts: []uint64{FlagWatchOnBusyUpdate}},
	...
	{Key: FlagWatchOnlyEmitEvents, Name: "only-emit-events", Flag: true, Spelling: "--only-emit-events", Conflicts: []uint64{FlagWatchManual}},
	...
	{Key: FlagWatchNoMeta, Name: "no-meta", Flag: true, Spelling: "--no-meta", Conflicts: []uint64{FlagWatchFsEvents}},
	...
	{Key: FlagWhichPlugin, Name: "plugin", Flag: true, Spelling: "--plugin", Conflicts: []uint64{FlagWhichVersion}},
	{Key: FlagWhichVersion, Name: "version", Flag: true, Spelling: "--version", Conflicts: []uint64{FlagWhichPlugin}},
