...
var HelpText = argv.HelpTable{
	...
	{Key: CmdBackendsLs, Short: "List built-in backends", VisibleAliases: []string{"list"}},
	...
	{Key: CmdBootstrapDotfilesStatus, Short: "Show the status of dotfiles from `[dotfiles]`", VisibleAliases: []string{"ls"}},
	...
	{Key: CmdBootstrapPackagesBrewUntap, Short: "Remove Homebrew tap URLs from [bootstrap.brew.taps]", VisibleAliases: []string{"remove", "rm"}},
	...
	{Key: CmdBootstrapPackagesStatus, Short: "Show the status of system packages from `[bootstrap.packages]`", VisibleAliases: []string{"ls"}},
	...
	{Key: CmdConfigLs, Short: "List config files currently in use", VisibleAliases: []string{"list"}},
	...
	{Key: CmdDotfilesStatus, Hide: true, Short: "Show the status of dotfiles from `[dotfiles]`", VisibleAliases: []string{"ls"}},
	...
	{Key: CmdDoctor, Short: "Check mise installation for possible problems", VisibleAliases: []string{"dr"}},
	{Key: FlagDoctorJson},
	...
	{Key: CmdLink, Short: "Symlinks a tool version into mise", Long: "Symlinks a tool version into mise\n\nUse this for adding installs either custom compiled outside mise or built with a different tool.", VisibleAliases: []string{"ln"}},
	...
	{Key: CmdPluginsLs, Short: "List installed plugins", Long: "List installed plugins\n\nCan also show remotely available plugins to install.", VisibleAliases: []string{"list"}},
	...
	{Key: CmdPluginsUninstall, Short: "Removes a plugin", VisibleAliases: []string{"remove", "rm"}},
...
var HelpMeta = argv.HelpSpec{Name: "mise", Bin: "mise", About: "Dev tools, env vars, and tasks in one CLI"}
