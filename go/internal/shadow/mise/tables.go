...
var HelpText = argv.HelpTable{
	...
	{Key: FlagLogLevel, Hide: true, ValueName: "LEVEL", ValueDemanded: true},
	...
	{Key: FlagActivateShell, Hide: true, ValueName: "SHELL", ValueDemanded: true, Short: "Shell type to generate the script for", Long: "Shell type to generate the script for"},
	...
	{Key: FlagBootstrapPackagesImportManager, ValueName: "MANAGER", ValueDemanded: true, Short: "Only import packages for this manager. Currently only `brew` is supported", Long: "Only import packages for this manager. Currently only `brew` is supported"},
	...
	{Key: FlagBootstrapPackagesPruneManager, ValueName: "MANAGER", ValueDemanded: true, Short: "Only prune packages for this manager. Currently only `brew` is supported", Long: "Only prune packages for this manager. Currently only `brew` is supported"},
	...
	{Key: FlagBootstrapRemoteConnectTimeout, ValueName: "CONNECT_TIMEOUT", ValueDemanded: true, Short: "SSH connection timeout in seconds", Long: "SSH connection timeout in seconds"},
	...
	{Key: FlagBootstrapRemoteOnly, Repeatable: true, ValueName: "ONLY", ValueDemanded: true, Short: "Run only one or more remote bootstrap parts", Long: "Run only one or more remote bootstrap parts"},
	...
	{Key: FlagBootstrapRemoteSkip, Repeatable: true, ValueName: "SKIP", ValueDemanded: true, Short: "Skip one or more remote bootstrap parts", Long: "Skip one or more remote bootstrap parts"},
	...
	{Key: FlagCompletionShell, Hide: true, ValueName: "SHELL_TYPE", ValueDemanded: true, Short: "Shell type to generate completions for", Long: "Shell type to generate completions for"},
	...
	{Key: FlagConfigSetType, ValueName: "TYPE", ValueDemanded: true},
	...
	{Key: FlagExecJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of jobs to run in parallel", Long: "Number of jobs to run in parallel\n[default: 4]"},
	{Key: FlagExecAllowEnv, Repeatable: true, ValueName: "VAR", ValueDemanded: true, Short: "Allow specific env var through (implies --deny-env for everything else)", Long: "Allow specific env var through (implies --deny-env for everything else)\nSupports wildcards, e.g. --allow-env='MYAPP_*'"},
	{Key: FlagExecAllowNet, Repeatable: true, ValueName: "HOST", ValueDemanded: true, Short: "Allow network to specific host (implies --deny-net for everything else)", Long: "Allow network to specific host (implies --deny-net for everything else)\nmacOS only in v1; on Linux falls back to allowing all network"},
	...
	{Key: FlagGenerateBootstrapLocalizedDir, ValueName: "LOCALIZED_DIR", ValueDemanded: true, Short: "Directory to put localized data into", Long: "Directory to put localized data into"},
	...
	{Key: FlagGenerateGitPreCommitTask, ValueName: "TASK", ValueDemanded: true, Short: "The task to run when the pre-commit hook is triggered", Long: "The task to run when the pre-commit hook is triggered"},
	...
	{Key: FlagGenerateGitPreCommitHook, ValueName: "HOOK", ValueDemanded: true, Short: "Which hook to generate (saves to .git/hooks/$hook)", Long: "Which hook to generate (saves to .git/hooks/$hook)"},
	...
	{Key: FlagGenerateGithubActionTask, ValueName: "TASK", ValueDemanded: true, Short: "The task to run when the workflow is triggered", Long: "The task to run when the workflow is triggered"},
	{Key: FlagGenerateGithubActionWrite, Short: "write to .github/workflows/$name.yml", Long: "write to .github/workflows/$name.yml"},
	{Key: FlagGenerateGithubActionName, ValueName: "NAME", ValueDemanded: true, Short: "the name of the workflow to generate", Long: "the name of the workflow to generate"},
	...
	{Key: FlagGenerateTaskDocsStyle, ValueName: "STYLE", ValueDemanded: true},
	...
	{Key: FlagGenerateTaskStubsDir, ValueName: "DIR", ValueDemanded: true, Short: "Directory to create task stubs inside of", Long: "Directory to create task stubs inside of"},
	...
	{Key: FlagGenerateToolStubHttp, ValueName: "HTTP", ValueDemanded: true, Short: "HTTP backend type to use", Long: "HTTP backend type to use"},
	...
	{Key: FlagGenerateToolStubVersion, ValueName: "VERSION", ValueDemanded: true, Short: "Version of the tool", Long: "Version of the tool"},
	...
	{Key: FlagHookEnvReason, Hide: true, ValueName: "REASON", ValueDemanded: true, Short: "Reason for calling hook-env (e.g., \"precmd\", \"chpwd\")", Long: "Reason for calling hook-env (e.g., \"precmd\", \"chpwd\")"},
	...
	{Key: FlagInstallJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of jobs to run in parallel", Long: "Number of jobs to run in parallel\n[default: 4]"},
	...
	{Key: FlagOciBuildOutput, ValueName: "OUTPUT", ValueDemanded: true, Short: "Output directory for the OCI image layout", Long: "Output directory for the OCI image layout"},
	...
	{Key: FlagOciRunEngine, ValueName: "ENGINE", ValueDemanded: true, Short: "Container engine to use (`auto`, `podman`, or `docker`)", Long: "Container engine to use (`auto`, `podman`, or `docker`)"},
	...
	{Key: FlagPluginsUpdateJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of jobs to run in parallel", Long: "Number of jobs to run in parallel\nDefault: 4"},
	...
	{Key: FlagRunAffectedBase, ValueName: "REV", ValueDemanded: true, Short: "Git base revision for --affected", Long: "Git base revision for --affected\nDefaults to MISE_AFFECTED_BASE, CI metadata, or HEAD~1"},
	...
	{Key: FlagRunAffectedHead, ValueName: "REV", ValueDemanded: true, Short: "Git head revision for --affected", Long: "Git head revision for --affected\nDefaults to MISE_AFFECTED_HEAD, CI metadata, or HEAD"},
	...
	{Key: FlagRunJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of tasks to run in parallel", Long: "Number of tasks to run in parallel\n[default: 4]\nConfigure with `jobs` config or `MISE_JOBS` env var"},
	...
	{Key: FlagRunAllowEnv, Repeatable: true, ValueName: "VAR", ValueDemanded: true, Short: "Allow specific env var through (implies --deny-env for everything else)", Long: "Allow specific env var through (implies --deny-env for everything else)\nSupports wildcards, e.g. --allow-env='MYAPP_*'"},
	...
	{Key: FlagRunTimeout, ValueName: "TIMEOUT", ValueDemanded: true, Short: "Timeout for the task to complete", Long: "Timeout for the task to complete\ne.g.: 30s, 5m"},
	...
	{Key: FlagSearchMatchType, ValueName: "MATCH_TYPE", ValueDemanded: true, Short: "Match type: equal, contains, or fuzzy", Long: "Match type: equal, contains, or fuzzy"},
	...
	{Key: FlagShellJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of jobs to run in parallel", Long: "Number of jobs to run in parallel\n[default: 4]"},
	...
	{Key: FlagTasksSort, ValueName: "COLUMN", ValueDemanded: true, Short: "Sort by column. Default is name.", Long: "Sort by column. Default is name."},
	{Key: FlagTasksSortOrder, ValueName: "SORT_ORDER", ValueDemanded: true, Short: "Sort order. Default is asc.", Long: "Sort order. Default is asc."},
	...
	{Key: FlagTasksLsSort, ValueName: "COLUMN", ValueDemanded: true, Short: "Sort by column. Default is name.", Long: "Sort by column. Default is name."},
	{Key: FlagTasksLsSortOrder, ValueName: "SORT_ORDER", ValueDemanded: true, Short: "Sort order. Default is asc.", Long: "Sort order. Default is asc."},
	...
	{Key: FlagTasksRunAffectedBase, ValueName: "REV", ValueDemanded: true, Short: "Git base revision for --affected", Long: "Git base revision for --affected\nDefaults to MISE_AFFECTED_BASE, CI metadata, or HEAD~1"},
	...
	{Key: FlagTasksRunAffectedHead, ValueName: "REV", ValueDemanded: true, Short: "Git head revision for --affected", Long: "Git head revision for --affected\nDefaults to MISE_AFFECTED_HEAD, CI metadata, or HEAD"},
	...
	{Key: FlagTasksRunJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of tasks to run in parallel", Long: "Number of tasks to run in parallel\n[default: 4]\nConfigure with `jobs` config or `MISE_JOBS` env var"},
	...
	{Key: FlagTasksRunAllowEnv, Repeatable: true, ValueName: "VAR", ValueDemanded: true, Short: "Allow specific env var through (implies --deny-env for everything else)", Long: "Allow specific env var through (implies --deny-env for everything else)\nSupports wildcards, e.g. --allow-env='MYAPP_*'"},
	...
	{Key: FlagTasksRunTimeout, ValueName: "TIMEOUT", ValueDemanded: true, Short: "Timeout for the task to complete", Long: "Timeout for the task to complete\ne.g.: 30s, 5m"},
	...
	{Key: FlagTestToolJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of tool tests to run in parallel", Long: "Number of tool tests to run in parallel\n[default: 4]"},
	...
	{Key: FlagUpgradeJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of jobs to run in parallel", Long: "Number of jobs to run in parallel\n[default: 4]"},
	...
	{Key: FlagUpgradeExclude, Repeatable: true, ValueName: "INSTALLED_TOOL", ValueDemanded: true, Short: "Tool(s) to exclude from upgrading", Long: "Tool(s) to exclude from upgrading\ne.g.: go python"},
	...
	{Key: FlagUseJobs, ValueName: "JOBS", ValueDemanded: true, Short: "Number of jobs to run in parallel", Long: "Number of jobs to run in parallel\n[default: 4]"},
	...
	{Key: FlagWatchGlob, Hide: true, Repeatable: true, ValueName: "GLOB", ValueDemanded: true, Short: "Files to watch", Long: "Files to watch\nDefaults to sources from the task(s)"},
	...
	{Key: FlagWhichTool, ValueName: "TOOL@VERSION", ValueDemanded: true, Short: "Use a specific tool@version", Long: "Use a specific tool@version\ne.g.: `mise which npm --tool=node@20`"},
