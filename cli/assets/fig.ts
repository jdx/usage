...
const completionSpec: Fig.Spec = {
      ...
      "subcommands": [
        {
          ...
          "options": [
            {
              "name": "--cache-key",
              "description": "A cache key to use for storing the results of calling the CLI with --usage-cmd",
              "isRepeatable": false,
              "args": {
                "name": "cache_key"
              }
            },
            {
              ...
              "description": "A .usage.kdl spec file to use for generating completions",
              "isRepeatable": false,
              "args": {
                "name": "file",
                "template": "filepaths"
            ...
            {
              "name": "--usage-bin",
              "description": "Override the bin used for calling back to usage-cli",
              "isRepeatable": false,
              "args": {
                "name": "usage_bin"
              }
            ...
            {
              "name": "--usage-cmd",
              "description": "A command which generates a usage spec e.g.: `mycli --usage` or `mycli completion usage` Defaults to \"$bin --usage\"",
              "isRepeatable": false,
              "args": {
                "name": "usage_cmd"
              }
  ...
  "args": {
    "name": "completions",
    "description": "Outputs completions for the specified shell for completing the `usage` CLI itself",
    "isOptional": true
  }
}
